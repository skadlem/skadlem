...
CS undergraduate at City University of Hong Kong (Year 3), previously on exchange at Vilnius University. I build low-latency systems and cross-platform mobile and AI-powered applications end to end.
...
- **Poker research** — [poKING](https://github.com/skadlem/poKING): a research-grade 6-max No-Limit Hold'em bot in Python — deterministic rules engine (side pots, all-ins, dealer rotation), per-opponent modeling (VPIP/PFR/aggression), bot & mirror detection, dynamic Kelly-style risk, and a numba-accelerated benchmark harness that resolves 50k-hand matchups in minutes
...
React Native, JavaScript, TypeScript, Python (FastAPI, numba, pytest), C++ (C++23, CMake, sanitizers), LangGraph / Gemini, RAG (ChromaDB), Next.js, Java, C#

## Currently

Exploring AI application development — LLM apps, RAG, agents — for the 2026 internship season.

## Languages

English (C1, IELTS 7.5) · Russian (fluent) · Kazakh (fluent) · German (A1)
